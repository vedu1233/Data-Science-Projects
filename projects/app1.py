...
def set_background(image_path):
    ...
    # Set the background using the encoded image
    page_bg = f"""
    <style>
    .stApp {{
...
st.markdown("""
    ...
    .title {
        ...
        margin-bottom: 20px;
        padding: 10px;
        border: 3px solid #000000; /* Black border around the title */
...
if st.button("Predict"):
    ...
    st.markdown(f'<div class="success-message">The predicted power generation is: {round(prediction, 2)}</div>', unsafe_allow_html=True)
